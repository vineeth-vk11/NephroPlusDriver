 ...
 import KmInputModule from './KmInputModule';
     ...
     <>
        <View style={{display:'flex',width:'100%',height:'100%',paddingLeft:'5%',paddingRight:'5%'}}>
            ...
            <View style={{marginTop:20}}>
                ...
                <View style={{flexDirection:'row',marginBottom:3}}>
                    ...
                    <Text style={{fontFamily: "JosefinSans-Regular",textDecorationLine:'none',color:'#828282',fontSize:12,marginLeft:'auto'}}>show more</Text>
                </View>
            </View>
            <View style={{marginTop:20}}>
        ...
        <View style={styles.bottom_container}>
            <TouchableOpacity
                ...
                <Text style={styles.label}>RO Water started</Text>
            </TouchableOpacity>
        </View>
        {/* <AcceptDeclineModal/> */}
        <KmInputModule/>
